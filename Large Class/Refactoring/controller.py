...
# SourceFileLoader("abstract_input", os.getcwd()+"//input_module//abstract_input.py").load_module()
...
# input_age = SourceFileLoader("input_age", os.getcwd()+"//input_module//input_age.py").load_module()
# from input_age import InputAge
# input_birthday = SourceFileLoader("input_birthday", os.getcwd()+"//input_module//input_birthday.py").load_module()
# from input_birthday import InputBirthday
# input_BMI = SourceFileLoader("input_BMI", os.getcwd()+"//input_module//input_BMI.py").load_module()
# from input_BMI import InputBMI
# input_employee_id = SourceFileLoader("input_employee_id", os.getcwd()+"//input_module//input_employee_id.py").load_module()
# from input_employee_id import InputEmployeeId
# input_gender = SourceFileLoader("input_gender", os.getcwd()+"//input_module//input_gender.py").load_module()
# from input_gender import InputGender
# input_salary = SourceFileLoader("input_salary", os.getcwd()+"//input_module//input_salary.py").load_module()
# from input_salary import InputSalary
# input_sales = SourceFileLoader("input_sales", os.getcwd()+"//input_module//input_sales.py").load_module()
...
class Controller(AbstractController):
    ...
    def __init__(self, view, model):
        ...
        self.input_compositor.add('InputSales')
        self.input_compositor.add('InputSalary') 
        self.input_compositor.add('InputGender')
        self.input_compositor.add('InputEmployeeId')
        self.input_compositor.add('InputBMI')
        self.input_compositor.add('InputBirthday')
        self.input_compositor.add('InputAge') 
